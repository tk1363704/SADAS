...
def define_arguments():
    ...
    # # house
    # parser.add_argument('--commodity', type=str, default="house",
    #                     help="[balloon, salary, house, industrial, business]")
    ...
    # parser.add_argument('--commodity', type=str, default="salary",
    #                     help="[balloon, salary, house, industrial, business]")
    # parser.add_argument('--cost_price', type=int, default=5000,
    #                     help='Budget of the salary')
    # parser.add_argument('--seller_init_price', type=int, default=6000,
